...
RUN mkdir ${HOME}/raspimouse-ros

COPY . ${HOME}/raspimouse-ros

#################################### CATKIN ####################################

RUN mkdir -p ${HOME}/catkin_ws/src && ln -s ${HOME}/raspimouse-ros ${HOME}/catkin_ws/src/.
